...
func TestFunction_stack(t *testing.T) {
	tt(t, func() {
		...
		expected := []_frame{
			{native: true, nativeFile: "function_stack_test.go", nativeLine: 30, offset: 0, callee: "github.com/kirillDanshin/otto.TestFunction_stack.func1.2"},
			{native: true, nativeFile: "function_stack_test.go", nativeLine: 25, offset: 0, callee: "github.com/kirillDanshin/otto.TestFunction_stack.func1.1"},
