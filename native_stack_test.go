		...
		vm.Set("ext2", func(c FunctionCall) Value {
			{
				...
				is(ctx.Stacktrace, []string{
					"github.com/kirillDanshin/otto.TestNativeStackFrames.func1.2 (native_stack_test.go:28)",
					"B (input.js:3:22)",
					"github.com/kirillDanshin/otto.TestNativeStackFrames.func1.1 (native_stack_test.go:20)",
					"A (input.js:2:22)", "input.js:4:7",
				})

				is(ctx.Callee, "github.com/kirillDanshin/otto.TestNativeStackFrames.func1.2")
		...
		vm.Set("ext3", func(c FunctionCall) Value {
			{
				...
				is(ctx.Stacktrace, []string{
					"github.com/kirillDanshin/otto.TestNativeStackFrames.func1.3 (native_stack_test.go:69)",
					"github.com/kirillDanshin/otto.TestNativeStackFrames.func1.2 (native_stack_test.go:28)",
					"B (input.js:3:22)",
					"github.com/kirillDanshin/otto.TestNativeStackFrames.func1.1 (native_stack_test.go:20)",
					"A (input.js:2:22)", "input.js:4:7",
				...
				is(ctx.Callee, "github.com/kirillDanshin/otto.TestNativeStackFrames.func1.3")
				is(ctx.Filename, "native_stack_test.go")
				is(ctx.Line, 69)
				is(ctx.Column, 0)
			}
